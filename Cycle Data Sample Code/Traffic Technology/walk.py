...
ret='There were '+str(x['total'])+' pedestrian movements recorded at the sample site on High Street over the last week (Monday - Sunday). This is '+str(int(x['total']/y['total']*100))+'% of the total from the previous week and '+ str(int(x['total']/z['total']*100))+'% of the total from the same week 1 year ago'
