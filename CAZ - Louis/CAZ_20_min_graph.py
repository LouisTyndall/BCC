...
#Plot a histogram for the time spent in the city centre, in 5 minute bins
plt.figure(figsize=(20,10))
plt.hist(df2['col']/pd.Timedelta(minutes=1), bins=144)
plt.title('Time Spent in the City Centre (minutes)', fontsize = 20)
