...
print('The number of journeys on time was:',ontime,'(',round(onpercent,1),'%)')
print('The number of journeys over the scheduled time was:',x,'(',round(latepercent,1),'%)')
print('The number of journeys under the scheduled time was:',y,'(',round(earlypercent,1),'%)')
