...
"""
set up parameters for the api search. Set up variables that check whether or not the database been updated in the 
last 15,30,45 and 60 minutes, respectively. 
"""
today = date.today()
